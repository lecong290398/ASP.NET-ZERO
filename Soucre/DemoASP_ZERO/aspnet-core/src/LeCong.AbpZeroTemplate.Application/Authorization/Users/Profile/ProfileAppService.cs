...
using LeCong.AbpZeroTemplate.Authorization.Users.Profile.Cache;
...
using LeCong.AbpZeroTemplate.Gdpr;
using LeCong.AbpZeroTemplate.Net.Sms;
using LeCong.AbpZeroTemplate.Security;
using LeCong.AbpZeroTemplate.Storage;
using LeCong.AbpZeroTemplate.Timing;

namespace LeCong.AbpZeroTemplate.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : AbpZeroTemplateAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("LeCong.AbpZeroTemplate",

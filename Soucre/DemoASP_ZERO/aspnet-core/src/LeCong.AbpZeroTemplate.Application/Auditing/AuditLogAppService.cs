...
using LeCong.AbpZeroTemplate.Auditing.Exporting;
...
using LeCong.AbpZeroTemplate.EntityHistory;
using EntityHistoryHelper = LeCong.AbpZeroTemplate.EntityHistory.EntityHistoryHelper;

namespace LeCong.AbpZeroTemplate.Auditing
{
    [DisableAuditing]

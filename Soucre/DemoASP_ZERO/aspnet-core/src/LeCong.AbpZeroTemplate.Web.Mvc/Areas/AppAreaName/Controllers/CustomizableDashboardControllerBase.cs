...
using LeCong.AbpZeroTemplate.Web.Areas.AppAreaName.Models.CustomizableDashboard;
using LeCong.AbpZeroTemplate.Web.Controllers;
using System.Linq;
using System.Threading.Tasks;
using LeCong.AbpZeroTemplate.Web.Areas.AppAreaName.Startup;
...
namespace LeCong.AbpZeroTemplate.Web.Areas.AppAreaName.Controllers
{
    public abstract class CustomizableDashboardControllerBase : AbpZeroTemplateControllerBase
    {
        ...
        public async Task<PartialViewResult> AddWidgetModal(string dashboardName, string pageId)
        {
            ...
            return PartialView(
                "~/Areas/AppAreaName/Views/Shared/Components/CustomizableDashboard/_AddWidgetModal.cshtml", viewModel);
        }

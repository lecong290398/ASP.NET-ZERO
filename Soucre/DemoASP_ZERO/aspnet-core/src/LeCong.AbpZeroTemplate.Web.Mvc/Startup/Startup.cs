...
using LeCong.AbpZeroTemplate.Schemas;
using LeCong.AbpZeroTemplate.Web.Chat.SignalR;
using LeCong.AbpZeroTemplate.Web.Common;
using LeCong.AbpZeroTemplate.Web.Resources;
using Swashbuckle.AspNetCore.Swagger;
using LeCong.AbpZeroTemplate.Web.IdentityServer;
using LeCong.AbpZeroTemplate.Web.Swagger;
using Stripe;
...
using LeCong.AbpZeroTemplate.Web.HealthCheck;
using Owl.reCAPTCHA;
using HealthChecksUISettings = HealthChecks.UI.Configuration.Settings;
using Microsoft.AspNetCore.Server.Kestrel.Https;
using Microsoft.Extensions.DependencyInjection.Extensions;
using LeCong.AbpZeroTemplate.Web.Extensions;
using SecurityStampValidatorCallback = LeCong.AbpZeroTemplate.Identity.SecurityStampValidatorCallback;

namespace LeCong.AbpZeroTemplate.Web.Startup
{
    public class Startup
    {
            ...
            if (WebConsts.SwaggerUiEnabled)
            {
                ...
                app.UseSwaggerUI(options =>
                {
                    ...
                    options.IndexStream = () => Assembly.GetExecutingAssembly()
                        .GetManifestResourceStream("LeCong.AbpZeroTemplate.Web.wwwroot.swagger.ui.index.html");
        ...
        private void ConfigureSwagger(IServiceCollection services)
        {
            services.AddSwaggerGen(options =>
            {
                ...
                var applicationXml = $"LeCong.AbpZeroTemplate.Application.xml";
                var applicationXmlPath = Path.Combine(AppContext.BaseDirectory, applicationXml);
                options.IncludeXmlComments(applicationXmlPath);

                var webCoreXmlFile = $"LeCong.AbpZeroTemplate.Web.Core.xml";

...
using LeCongCompany.LeCongTemplate.MultiTenancy.HostDashboard;
...
namespace LeCongCompany.LeCongTemplate.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(LeCongTemplateDbContext context, SubscriptionPayment subscriptionPayment)
        {

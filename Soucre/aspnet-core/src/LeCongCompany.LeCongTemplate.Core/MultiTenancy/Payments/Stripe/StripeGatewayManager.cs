...
{
    public class StripeGatewayManager : LeCongTemplateServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "LeCongTemplate";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + LeCongTemplateConsts.Currency;
        }

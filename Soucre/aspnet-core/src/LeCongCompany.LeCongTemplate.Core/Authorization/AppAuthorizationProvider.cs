...
namespace LeCongCompany.LeCongTemplate.Authorization
{
    ...
    public class AppAuthorizationProvider : AuthorizationProvider
    {
        ...
        public override void SetPermissions(IPermissionDefinitionContext context)
        {
            ...
            phoneBook.CreateChildPermission(AppPermissions.Pages_PhoneBook_CreatePerson, L("CreateNewPerson"));
            phoneBook.CreateChildPermission(AppPermissions.Pages_PhoneBook_DeletePerson, L("DeletePerson"));

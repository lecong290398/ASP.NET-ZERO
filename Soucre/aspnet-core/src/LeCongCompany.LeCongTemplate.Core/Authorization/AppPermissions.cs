namespace LeCongCompany.LeCongTemplate.Authorization
{
    ...
    public static class AppPermissions
    {
        ...
        public const string Pages_PhoneBook_CreatePerson = "Pages.PhoneBook.CreatePerson";
        public const string Pages_PhoneBook_DeletePerson = "Pages_PhoneBook_DeletePerson";

...
namespace LeCongCompany.LeCongTemplate.Authorization.Impersonation
{
    public class ImpersonationManager : LeCongTemplateDomainServiceBase, IImpersonationManager
    {

...
namespace LeCongCompany.LeCongTemplate.Web.Authentication.JwtBearer
{
    public class LeCongTemplateJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public LeCongTemplateJwtSecurityTokenHandler()
        {

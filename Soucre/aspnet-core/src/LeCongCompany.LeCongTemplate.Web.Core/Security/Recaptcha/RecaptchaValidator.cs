...
namespace LeCongCompany.LeCongTemplate.Web.Security.Recaptcha
{
    public class RecaptchaValidator : LeCongTemplateServiceBase, IRecaptchaValidator, ITransientDependency
    {

...
using LeCongCompany.LeCongTemplate.Web.Startup.ExternalLoginInfoProviders;
...
namespace LeCongCompany.LeCongTemplate.Web.Startup
{
    ...
    public class LeCongTemplateWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public LeCongTemplateWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(LeCongTemplateWebHostModule).GetAssembly());
        }

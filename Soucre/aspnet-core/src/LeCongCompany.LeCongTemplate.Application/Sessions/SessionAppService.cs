...
using LeCongCompany.LeCongTemplate.Features;

namespace LeCongCompany.LeCongTemplate.Sessions
{
    public class SessionAppService : LeCongTemplateAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = LeCongTemplateConsts.Currency,
                        CurrencySign = LeCongTemplateConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = LeCongTemplateConsts.AllowTenantsToChangeEmailSettings,

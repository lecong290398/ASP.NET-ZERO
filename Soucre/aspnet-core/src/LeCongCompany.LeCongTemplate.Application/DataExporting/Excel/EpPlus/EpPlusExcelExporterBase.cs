...
namespace LeCongCompany.LeCongTemplate.DataExporting.Excel.EpPlus
{
    public abstract class EpPlusExcelExporterBase : LeCongTemplateServiceBase, ITransientDependency
    {

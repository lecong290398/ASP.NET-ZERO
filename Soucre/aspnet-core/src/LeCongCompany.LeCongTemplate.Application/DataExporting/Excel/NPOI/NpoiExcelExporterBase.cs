...
namespace LeCongCompany.LeCongTemplate.DataExporting.Excel.NPOI
{
    public abstract class NpoiExcelExporterBase : LeCongTemplateServiceBase, ITransientDependency
    {

...
namespace LeCongCompany.LeCongTemplate.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : LeCongTemplateAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<LeCongTemplateDbContext> _migrator;
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{LeCongTemplateConsts.ConnectionStringName}", constring);
        }

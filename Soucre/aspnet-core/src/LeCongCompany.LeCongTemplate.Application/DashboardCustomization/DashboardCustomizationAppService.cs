...
using LeCongCompany.LeCongTemplate.DashboardCustomization.Definitions;
using LeCongCompany.LeCongTemplate.DashboardCustomization.Dto;
using Newtonsoft.Json;

namespace LeCongCompany.LeCongTemplate.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : LeCongTemplateAppServiceBase, IDashboardCustomizationAppService
    {

...
using LeCongCompany.LeCongTemplate.Auditing.Exporting;
...
using EntityHistoryHelper = LeCongCompany.LeCongTemplate.EntityHistory.EntityHistoryHelper;

namespace LeCongCompany.LeCongTemplate.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : LeCongTemplateAppServiceBase, IAuditLogAppService
    {

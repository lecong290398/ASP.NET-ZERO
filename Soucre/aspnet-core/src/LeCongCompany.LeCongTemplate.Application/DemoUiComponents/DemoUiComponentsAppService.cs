...
using LeCongCompany.LeCongTemplate.DemoUiComponents.Dto;

namespace LeCongCompany.LeCongTemplate.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : LeCongTemplateAppServiceBase, IDemoUiComponentsAppService
    {

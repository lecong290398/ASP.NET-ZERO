...
namespace LeCongCompany.LeCongTemplate
{
    internal static class CustomDtoMapper
    {
        public static void CreateMappings(IMapperConfigurationExpression configuration)
        {
            ...
            configuration.CreateMap<Person.Person, PersonListDto>();
            configuration.CreateMap<Phone.Phone, PhoneInPersonListDto>();
            configuration.CreateMap<AddPhoneInput, Phone.Phone>();
            configuration.CreateMap<Person.Person, EditPersonInput>();
            configuration.CreateMap<Person.Person, GetPersonForEditOutput>();

...
using LeCongCompany.LeCongTemplate.MultiTenancy.Payments.Stripe;
using LeCongCompany.LeCongTemplate.MultiTenancy.Payments.Stripe.Dto;
using Stripe;
using Stripe.Checkout;

namespace LeCongCompany.LeCongTemplate.MultiTenancy.Payments
{
    public class StripePaymentAppService : LeCongTemplateAppServiceBase, IStripePaymentAppService
    {

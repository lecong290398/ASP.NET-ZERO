...
using LeCongCompany.LeCongTemplate.Authorization.Users.Profile.Cache;
...
using LeCongCompany.LeCongTemplate.Gdpr;
...
{
    [AbpAuthorize]
    public class ProfileAppService : LeCongTemplateAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("LeCongCompany.LeCongTemplate",

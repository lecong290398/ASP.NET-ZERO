...
using LeCongCompany.LeCongTemplate.Core.Base;
using LeCongCompany.LeCongTemplate.Core.Extensions;
using LeCongCompany.LeCongTemplate.Dto;
using LeCongCompany.LeCongTemplate.Types;

namespace LeCongCompany.LeCongTemplate.Queries
{
    public class OrganizationUnitQuery : LeCongTemplateQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {

...
namespace LeCongCompany.LeCongTemplate.Core.Base
{
    public abstract class LeCongTemplateQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected LeCongTemplateQueryBase(string fieldName,

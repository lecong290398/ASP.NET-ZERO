...
namespace LeCongCompany.LeCongTemplate.Web.Startup
{
    ...
    public class LeCongTemplateWebMvcModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public LeCongTemplateWebMvcModule(IWebHostEnvironment env)
        {
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Navigation.Providers.Add<AppAreaLeCongNavigationProvider>();
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(LeCongTemplateWebMvcModule).GetAssembly());
        }

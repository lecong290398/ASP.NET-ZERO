...
using LeCongCompany.LeCongTemplate.Identity;
using LeCongCompany.LeCongTemplate.Schemas;
using LeCongCompany.LeCongTemplate.Web.Chat.SignalR;
using LeCongCompany.LeCongTemplate.Web.Common;
using LeCongCompany.LeCongTemplate.Web.Resources;
using Swashbuckle.AspNetCore.Swagger;
using LeCongCompany.LeCongTemplate.Web.IdentityServer;
using LeCongCompany.LeCongTemplate.Web.Swagger;
using Stripe;
...
using LeCongCompany.LeCongTemplate.Web.HealthCheck;
using Owl.reCAPTCHA;
using HealthChecksUISettings = HealthChecks.UI.Configuration.Settings;
using Microsoft.AspNetCore.Server.Kestrel.Https;
using Microsoft.Extensions.DependencyInjection.Extensions;
using LeCongCompany.LeCongTemplate.Web.Extensions;
using SecurityStampValidatorCallback = LeCongCompany.LeCongTemplate.Identity.SecurityStampValidatorCallback;

namespace LeCongCompany.LeCongTemplate.Web.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            return services.AddAbp<LeCongTemplateWebMvcModule>(options =>
            {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            if (env.IsDevelopment())
            {
                ...
                app.UseLeCongTemplateForwardedHeaders();
            }
            else
            {
            ...
            if (WebConsts.SwaggerUiEnabled)
            {
                ...
                {
                    options.SwaggerEndpoint(_appConfiguration["App:SwaggerEndPoint"], "LeCongTemplate API V1");
                    options.IndexStream = () => Assembly.GetExecutingAssembly()
                        .GetManifestResourceStream("LeCongCompany.LeCongTemplate.Web.wwwroot.swagger.ui.index.html");
        ...
        private void ConfigureSwagger(IServiceCollection services)
        {
            ...
            {
                options.SwaggerDoc("v1", new OpenApiInfo() {Title = "LeCongTemplate API", Version = "v1"});
                ...
                var applicationXml = $"LeCongCompany.LeCongTemplate.Application.xml";
                var applicationXmlPath = Path.Combine(AppContext.BaseDirectory, applicationXml);
                options.IncludeXmlComments(applicationXmlPath);

                var webCoreXmlFile = $"LeCongCompany.LeCongTemplate.Web.Core.xml";

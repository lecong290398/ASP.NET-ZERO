...
{
    public class AppAreaLeCongMenuViewComponent : LeCongTemplateViewComponent
    {
        private readonly IUserNavigationManager _userNavigationManager;
        private readonly IAbpSession _abpSession;
        private readonly TenantManager _tenantManager;

        public AppAreaLeCongMenuViewComponent(
        ...
        public async Task<IViewComponentResult> InvokeAsync(bool isLeftMenuUsed, string currentPageName = null)
        {
            ...
            {
                Menu = await _userNavigationManager.GetMenuAsync(AppAreaLeCongNavigationProvider.MenuName, _abpSession.ToUserIdentifier()),
            ...
            var subscriptionManagement = FindMenuItemOrNull(model.Menu.Items, AppAreaLeCongPageNames.Tenant.SubscriptionManagement);

...
using LeCongCompany.LeCongTemplate.Web.Areas.AppAreaLeCong.Models.Webhooks;
using LeCongCompany.LeCongTemplate.Web.Controllers;
using LeCongCompany.LeCongTemplate.WebHooks;
...
namespace LeCongCompany.LeCongTemplate.Web.Areas.AppAreaLeCong.Controllers
{
    ...
    public class WebhookSubscriptionController : LeCongTemplateControllerBase
    {

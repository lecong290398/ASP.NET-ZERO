...
using LeCongCompany.LeCongTemplate.Web.Areas.AppAreaLeCong.Models.OrganizationUnits;
...
namespace LeCongCompany.LeCongTemplate.Web.Areas.AppAreaLeCong.Controllers
{
    ...
    public class OrganizationUnitsController : LeCongTemplateControllerBase
    {

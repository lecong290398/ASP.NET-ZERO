...
using LeCongCompany.LeCongTemplate.Web.Areas.AppAreaLeCong.Models.Languages;
...
namespace LeCongCompany.LeCongTemplate.Web.Areas.AppAreaLeCong.Controllers
{
    ...
    public class LanguagesController : LeCongTemplateControllerBase
    {
            ...
            string filterText = "")
        {
            ...
            {
                sourceName = LeCongTemplateConsts.LocalizationSourceName;
            }

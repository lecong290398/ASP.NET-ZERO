...
using LeCongCompany.LeCongTemplate.Configuration.Tenants;
...
using LeCongCompany.LeCongTemplate.Web.Areas.AppAreaLeCong.Models.Settings;
...
namespace LeCongCompany.LeCongTemplate.Web.Areas.AppAreaLeCong.Controllers
{
    ...
    public class SettingsController : LeCongTemplateControllerBase
    {

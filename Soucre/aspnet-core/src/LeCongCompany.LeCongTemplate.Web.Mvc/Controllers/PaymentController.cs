...
using LeCongCompany.LeCongTemplate.Web.Models.Payment;
using System;
...
{
    public class PaymentController : LeCongTemplateControllerBase
    {
                ...
                if (tenant.EditionId.HasValue)
                {
                    ...
                    if (((SubscribableEdition)currentEdition).IsFree)
                    {
                        ...
                        if (((SubscribableEdition)upgradeEdition).IsFree)
                        {
                            ...
                            return RedirectToAction("Index", "SubscriptionManagement", new { area = "AppAreaLeCong" });
                        }

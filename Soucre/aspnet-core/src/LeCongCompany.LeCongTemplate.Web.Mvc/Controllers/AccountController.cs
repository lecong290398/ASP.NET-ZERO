...
using LeCongCompany.LeCongTemplate.Authentication.TwoFactor.Google;
...
using LeCongCompany.LeCongTemplate.Authorization.Impersonation;
using LeCongCompany.LeCongTemplate.Authorization.Users;
using LeCongCompany.LeCongTemplate.Configuration;
using LeCongCompany.LeCongTemplate.Debugging;
using LeCongCompany.LeCongTemplate.Identity;
using LeCongCompany.LeCongTemplate.MultiTenancy;
using LeCongCompany.LeCongTemplate.Net.Sms;
using LeCongCompany.LeCongTemplate.Notifications;
using LeCongCompany.LeCongTemplate.Web.Models.Account;
...
using LeCongCompany.LeCongTemplate.Web.Authentication.External;
using LeCongCompany.LeCongTemplate.Web.Security.Recaptcha;
using LeCongCompany.LeCongTemplate.Web.Session;
using LeCongCompany.LeCongTemplate.Web.Views.Shared.Components.TenantChange;
using Abp.CachedUniqueKeys;
using Abp.AspNetCore.Mvc.Caching;

namespace LeCongCompany.LeCongTemplate.Web.Controllers
{
    public class AccountController : LeCongTemplateControllerBase
    {
        ...
        {
            return RedirectToAction("Index", "Home", new {area = "AppAreaLeCong"});
        }

        public string GetAppHomeUrl()
        {
            return Url.Action("Index", "Home", new {area = "AppAreaLeCong"});
        }

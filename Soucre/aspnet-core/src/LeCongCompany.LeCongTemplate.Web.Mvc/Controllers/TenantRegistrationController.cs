...
using LeCongCompany.LeCongTemplate.Web.Models.TenantRegistration;

namespace LeCongCompany.LeCongTemplate.Web.Controllers
{
    public class TenantRegistrationController : LeCongTemplateControllerBase
    {
            ...
            try
            {
                    ...
                    !_webUrlService.SupportsTenancyNameInUrl)
                {
                    ...
                    if (loginResult.Result == AbpLoginResultType.Success)
                    {
                        ...
                        return Redirect(Url.Action("Index", "Home", new { area = "AppAreaLeCong" }));
                    }

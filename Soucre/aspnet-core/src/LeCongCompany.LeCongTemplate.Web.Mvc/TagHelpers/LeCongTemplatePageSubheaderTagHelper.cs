...
namespace LeCongCompany.LeCongTemplate.Web.TagHelpers
{
    ...
    public class LeCongTemplatePageSubheaderTagHelper : TagHelper
    {
        ...
        public LeCongTemplatePageSubheaderTagHelper(IUiThemeCustomizerFactory uiThemeCustomizerFactory)
        {

  ...
  app.modals.MySettingsModal = function () {
    ...
    this.init = function (modalManager) {
      ...
      var smsVerificationModal = new app.ModalManager({
        viewUrl: abp.appPath + 'AppAreaLeCong/Profile/SmsVerificationModal',
        scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaLeCong/Views/Profile/_SmsVerificationModal.js',

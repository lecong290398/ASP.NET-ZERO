(function () {
  app.modals.ManageDynamicEntityPropertyModal = function () {
    ...
    var _createModal = new app.ModalManager({
      viewUrl: abp.appPath + 'AppAreaLeCong/DynamicEntityProperty/CreateModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaLeCong/Views/DynamicEntityProperties/_CreateModal.js',

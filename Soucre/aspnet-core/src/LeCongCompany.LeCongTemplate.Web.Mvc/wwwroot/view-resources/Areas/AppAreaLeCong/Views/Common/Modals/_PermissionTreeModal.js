(function () {
  ...
  app.modals.PermissionTreeModal.create = function (options) {
    return new app.ModalManager({
      viewUrl: abp.appPath + 'AppAreaLeCong/Common/PermissionTreeModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaLeCong/Views/Common/Modals/_PermissionTreeModal.js',

(function () {
  $(function () {
    ...
    var _entityTypeFullName = 'LeCongCompany.LeCongTemplate.MultiTenancy.Tenant';
    ...
    var _createModal = new app.ModalManager({
      viewUrl: abp.appPath + 'AppAreaLeCong/Tenants/CreateModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaLeCong/Views/Tenants/_CreateModal.js',
      modalClass: 'CreateTenantModal',
    });

    var _editModal = new app.ModalManager({
      viewUrl: abp.appPath + 'AppAreaLeCong/Tenants/EditModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaLeCong/Views/Tenants/_EditModal.js',
      modalClass: 'EditTenantModal',
    });

    var _featuresModal = new app.ModalManager({
      viewUrl: abp.appPath + 'AppAreaLeCong/Tenants/FeaturesModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaLeCong/Views/Tenants/_FeaturesModal.js',

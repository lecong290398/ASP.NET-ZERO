$(function () {
  ...
  var _addWidgetModal = new app.ModalManager({
    viewUrl: abp.appPath + 'AppAreaLeCong/' + $('#DashboardName').val() + '/AddWidgetModal',
    scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaLeCong/Views/CustomizableDashboard/_AddWidgetModal.js',

  ...
  getFormattedMessages: function (messages) {
    $.each(messages, function (index, message) {
      ...
      if (message.message.startsWith('[image]')) {
        ...
        var imageUrl = abp.appPath + 'AppAreaLeCong/Chat/GetImage?id=' + message.id + '&contentType=' + image.contentType;
        ...
        var fileUrl = abp.appPath + 'AppAreaLeCong/Chat/GetFile?id=' + message.id + '&contentType=' + file.contentType;
        var uploadedFileMsg =
          '<a href="' +
          fileUrl +
...
(function ($) {
  $(function () {
    ...
    var url = abp.appPath + 'AppAreaLeCong/Chat/UploadFile';

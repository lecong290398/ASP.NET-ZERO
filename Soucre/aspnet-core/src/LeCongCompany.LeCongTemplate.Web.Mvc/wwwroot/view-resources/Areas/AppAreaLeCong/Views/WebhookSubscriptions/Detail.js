(function () {
  $(function () {
    ...
    var _createOrEditModal = new app.ModalManager({
      viewUrl: abp.appPath + 'AppAreaLeCong/WebhookSubscription/EditModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaLeCong/Views/WebhookSubscriptions/_CreateOrEditModal.js',
          ...
          rowAction: {
            ...
            items: [
              ...
              },
              {
                ...
                action: function (data) {
                  window.location = '/AppAreaLeCong/WebhookSubscription/WebhookEventDetail/' + data.record.webhookEventId;
                },
              },
            ],
          },

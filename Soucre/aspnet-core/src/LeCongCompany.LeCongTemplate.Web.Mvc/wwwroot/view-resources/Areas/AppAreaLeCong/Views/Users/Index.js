(function () {
  $(function () {
    ...
    var _createOrEditModal = new app.ModalManager({
      viewUrl: abp.appPath + 'AppAreaLeCong/Users/CreateOrEditModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaLeCong/Views/Users/_CreateOrEditModal.js',
      modalClass: 'CreateOrEditUserModal',
    });

    var _userPermissionsModal = new app.ModalManager({
      viewUrl: abp.appPath + 'AppAreaLeCong/Users/PermissionsModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaLeCong/Views/Users/_PermissionsModal.js',
              ...
              },
              {
                ...
                visible: function () {
                  return _dynamicEntityPropertyManager.canShow(
                    'LeCongCompany.LeCongTemplate.Authorization.Users.User'
                  );
                },
                action: function (data) {
                  _dynamicEntityPropertyManager.modal.open({
                    entityFullName: 'LeCongCompany.LeCongTemplate.Authorization.Users.User',

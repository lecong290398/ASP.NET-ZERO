(function () {
  app.modals.EntityTypeHistoryModal = function () {
    ...
    function showEntityChangeDetails(entityChange) {
      var entityChangeDetailModal = new app.ModalManager({
        viewUrl: abp.appPath + 'AppAreaLeCong/AuditLogs/EntityChangeDetailModal',
  ...
  app.modals.EntityTypeHistoryModal.create = function () {
    return new app.ModalManager({
      viewUrl: abp.appPath + 'AppAreaLeCong/Common/EntityTypeHistoryModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaLeCong/Views/Common/Modals/_EntityTypeHistoryModal.js',

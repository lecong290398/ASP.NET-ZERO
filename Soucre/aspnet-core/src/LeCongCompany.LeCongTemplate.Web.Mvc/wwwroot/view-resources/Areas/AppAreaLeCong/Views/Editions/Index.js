(function () {
  $(function () {
    ...
    var _createModal = new app.ModalManager({
      viewUrl: abp.appPath + 'AppAreaLeCong/Editions/CreateModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaLeCong/Views/Editions/_CreateModal.js',
      modalClass: 'CreateEditionModal',
    });

    var _editModal = new app.ModalManager({
      viewUrl: abp.appPath + 'AppAreaLeCong/Editions/EditModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaLeCong/Views/Editions/_EditModal.js',
      modalClass: 'EditEditionModal',
    });

    var _moveTenantsToAnotherEditionModal = new app.ModalManager({
      viewUrl: abp.appPath + 'AppAreaLeCong/Editions/MoveTenantsToAnotherEdition',
      scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaLeCong/Views/Editions/_MoveTenantsToAnotherEditionModal.js',

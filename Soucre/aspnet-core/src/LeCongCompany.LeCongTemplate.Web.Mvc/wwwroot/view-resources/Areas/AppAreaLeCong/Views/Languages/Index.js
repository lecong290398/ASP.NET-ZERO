(function () {
  $(function () {
    ...
    var _createOrEditModal = new app.ModalManager({
      viewUrl: abp.appPath + 'AppAreaLeCong/Languages/CreateOrEditModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaLeCong/Views/Languages/_CreateOrEditModal.js',
          ...
          rowAction: {
            ...
            items: [
              ...
              },
              {
                ...
                action: function (data) {
                  document.location.href = abp.appPath + 'AppAreaLeCong/Languages/Texts?languageName=' + data.record.name;
                },
              },
              {

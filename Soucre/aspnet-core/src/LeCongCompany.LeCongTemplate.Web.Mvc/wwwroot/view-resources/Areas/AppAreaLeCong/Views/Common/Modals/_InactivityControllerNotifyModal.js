(function () {
  ...
  app.modals.InactivityControllerNotifyModal.create = function () {
    var modal = new app.ModalManager({
      viewUrl: abp.appPath + 'AppAreaLeCong/Common/InactivityControllerNotifyModal',
      scriptUrl:
        abp.appPath + 'view-resources/Areas/AppAreaLeCong/Views/Common/Modals/_InactivityControllerNotifyModal.js',

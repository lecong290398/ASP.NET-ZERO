(function () {
  ...
  app.modals.ManageDynamicEntityPropertyValuesModal.create = function () {
    return new app.ModalManager({
      viewUrl: abp.appPath + 'AppAreaLeCong/DynamicEntityPropertyValue/ManageDynamicEntityPropertyValuesModal',
      scriptUrl:
        abp.appPath +
        'view-resources/Areas/AppAreaLeCong/Views/DynamicEntityPropertyValues/ManageDynamicEntityPropertyValuesModal.js',

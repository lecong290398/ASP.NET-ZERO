(function () {
  $(function () {
    ...
    var _createModal = new app.ModalManager({
      viewUrl: abp.appPath + 'AppAreaLeCong/OrganizationUnits/CreateModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaLeCong/Views/OrganizationUnits/_CreateModal.js',
      modalClass: 'CreateOrganizationUnitModal',
    });

    var _editModal = new app.ModalManager({
      viewUrl: abp.appPath + 'AppAreaLeCong/OrganizationUnits/EditModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaLeCong/Views/OrganizationUnits/_EditModal.js',
      modalClass: 'EditOrganizationUnitModal',
    });

    var _addUserModal = new app.ModalManager({
      viewUrl: abp.appPath + 'AppAreaLeCong/OrganizationUnits/AddMemberModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaLeCong/Views/OrganizationUnits/_AddMemberModal.js',
    ...
    var _addRoleModal = new app.ModalManager({
      viewUrl: abp.appPath + 'AppAreaLeCong/OrganizationUnits/AddRoleModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaLeCong/Views/OrganizationUnits/_AddRoleModal.js',

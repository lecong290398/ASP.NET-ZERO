(function ($) {
  $(function () {
    ...
    var mySettingsModal = new app.ModalManager({
      viewUrl: abp.appPath + 'AppAreaLeCong/Profile/MySettingsModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaLeCong/Views/Profile/_MySettingsModal.js',
    ...
    var changePasswordModal = new app.ModalManager({
      viewUrl: abp.appPath + 'AppAreaLeCong/Profile/ChangePasswordModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaLeCong/Views/Profile/_ChangePasswordModal.js',
    ...
    var changeProfilePictureModal = new app.ModalManager({
      viewUrl: abp.appPath + 'AppAreaLeCong/Profile/ChangePictureModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaLeCong/Views/Profile/_ChangePictureModal.js',
    ...
    var manageLinkedAccountsModal = new app.ModalManager({
      viewUrl: abp.appPath + 'AppAreaLeCong/Profile/LinkedAccountsModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaLeCong/Views/Profile/_LinkedAccountsModal.js',
    ...
    var userDelegationsModal = new app.ModalManager({
      viewUrl: abp.appPath + 'AppAreaLeCong/Profile/UserDelegationsModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaLeCong/Views/Profile/_UserDelegationsModal.js',

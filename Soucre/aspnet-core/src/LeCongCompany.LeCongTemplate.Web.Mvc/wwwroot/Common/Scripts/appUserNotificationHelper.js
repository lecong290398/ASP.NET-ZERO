...
(function ($) {
  app.UserNotificationHelper = (function () {
    return function () {
      ...
      /* Example:
            abp.notifications.messageFormatters['LeCongCompany.LeCongTemplate.MyNotificationDataType'] = function(userNotification) {
      ...
      function getUrl(userNotification) {
        switch (userNotification.notification.notificationName) {
          case 'App.NewUserRegistered':
            return '/AppAreaLeCong/users?filterText=' + userNotification.notification.data.properties.emailAddress;
          case 'App.NewTenantRegistered':
            return '/AppAreaLeCong/tenants?filterText=' + userNotification.notification.data.properties.tenancyName;
      ...
      var openSettingsModal = function () {
        new app.ModalManager({
          viewUrl: abp.appPath + 'AppAreaLeCong/Notifications/SettingsModal',
          scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaLeCong/Views/Notifications/_SettingsModal.js',

...
{
    public class LeCongTemplateDbContext : AbpZeroDbContext<Tenant, Role, User, LeCongTemplateDbContext>, IAbpPersistedGrantDbContext
    {
        ...
        public virtual DbSet<Phone.Phone> Phone { get; set; }


        public LeCongTemplateDbContext(DbContextOptions<LeCongTemplateDbContext> options)
            : base(options)
        {

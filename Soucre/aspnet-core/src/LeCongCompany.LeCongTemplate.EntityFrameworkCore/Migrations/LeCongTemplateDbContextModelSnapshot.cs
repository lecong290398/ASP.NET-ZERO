...
namespace LeCongCompany.LeCongTemplate.Migrations
{
    ...
    partial class LeCongTemplateDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LeCongCompany.LeCongTemplate.Authorization.Delegation.UserDelegation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("LeCongCompany.LeCongTemplate.MultiTenancy.Payments.SubscriptionPaymentExtensionData", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("LeCongCompany.LeCongTemplate.Person.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LeCongCompany.LeCongTemplate.Phone.Phone", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("LeCongCompany.LeCongTemplate.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("LeCongCompany.LeCongTemplate.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("LeCongCompany.LeCongTemplate.Phone.Phone", b =>
                {
                    b.HasOne("LeCongCompany.LeCongTemplate.Person.Person", "Person")
                        .WithMany("Phones")

...
using LeCongCompany.LeCongTemplate.Friendships;
using LeCongCompany.LeCongTemplate.MultiTenancy.Payments;

namespace LeCongCompany.LeCongTemplate.Migrations
{
    [DbContext(typeof(LeCongTemplateDbContext))]
    ...
    partial class Invoice_Changes
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("LeCongCompany.LeCongTemplate.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LeCongCompany.LeCongTemplate.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("LeCongCompany.LeCongTemplate.Chat.ChatMessage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("LeCongCompany.LeCongTemplate.Friendships.Friendship", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("LeCongCompany.LeCongTemplate.MultiTenancy.Accounting.Invoice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LeCongCompany.LeCongTemplate.MultiTenancy.Payments.SubscriptionPayment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("LeCongCompany.LeCongTemplate.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LeCongCompany.LeCongTemplate.Storage.BinaryObject", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LeCongCompany.LeCongTemplate.Editions.SubscribableEdition", b =>
                {
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("LeCongCompany.LeCongTemplate.Authorization.Roles.Role")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("LeCongCompany.LeCongTemplate.Authorization.Users.User")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("LeCongCompany.LeCongTemplate.Authorization.Roles.Role", b =>
                {
                    b.HasOne("LeCongCompany.LeCongTemplate.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("LeCongCompany.LeCongTemplate.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("LeCongCompany.LeCongTemplate.Authorization.Users.User", "LastModifierUser")
                        .WithMany()

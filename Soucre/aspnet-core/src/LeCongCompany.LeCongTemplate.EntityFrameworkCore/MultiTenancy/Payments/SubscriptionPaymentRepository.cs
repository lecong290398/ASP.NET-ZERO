...
{
    public class SubscriptionPaymentRepository : LeCongTemplateRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<LeCongTemplateDbContext> dbContextProvider)

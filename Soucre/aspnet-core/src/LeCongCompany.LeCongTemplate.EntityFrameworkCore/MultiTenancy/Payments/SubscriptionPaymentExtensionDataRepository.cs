...
using LeCongCompany.LeCongTemplate.EntityFrameworkCore.Repositories;

namespace LeCongCompany.LeCongTemplate.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : LeCongTemplateRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<LeCongTemplateDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }

...
using LeCongCompany.LeCongTemplate.Web.Public.Startup;
using LeCongCompany.LeCongTemplate.Web.Session;

namespace LeCongCompany.LeCongTemplate.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : LeCongTemplateViewComponent
    {

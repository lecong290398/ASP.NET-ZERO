...
using LeCongCompany.LeCongTemplate.Controls;
using LeCongCompany.LeCongTemplate.Dto;
using LeCongCompany.LeCongTemplate.Extensions;
using LeCongCompany.LeCongTemplate.Localization;
using LeCongCompany.LeCongTemplate.UI;
using LeCongCompany.LeCongTemplate.UI.Assets;
using LeCongCompany.LeCongTemplate.Views;
using DependencyResolver = LeCongCompany.LeCongTemplate.Core.Dependency.DependencyResolver;
...
namespace LeCongCompany.LeCongTemplate.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "LeCongTemplate";

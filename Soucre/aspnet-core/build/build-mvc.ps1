...
$webMvcFolder = Join-Path $slnFolder "src/LeCongCompany.LeCongTemplate.Web.Mvc"
$webPublicFolder = Join-Path $slnFolder "src/LeCongCompany.LeCongTemplate.Web.Public"
...
dotnet restore LeCongCompany.LeCongTemplate.Web.sln
